    ...
    <div className="bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col">
      ...
      <div className="w-full">
        <input
          ...
          placeholder="Email"
        />
        <button className="bg-blue-950 text-white font-semibold px-6 py-3.5 mt-3 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block mx-auto rounded-lg outline-none transition-all duration-200 hover:bg-blue-800 cursor-pointer">
          Subscribe
        </button>
      </div>
    </div>
